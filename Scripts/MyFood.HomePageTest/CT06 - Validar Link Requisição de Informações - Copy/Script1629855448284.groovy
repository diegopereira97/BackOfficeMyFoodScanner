...
WebUI.verifyElementText(findTestObject('MyFood.Page_Home/Texts/Page_Home'), 'Seja bem vindo!')

WebUI.click(findTestObject('MyFood.Page_Home/Links/a_Requisio de Informaes'))

WebUI.verifyElementText(findTestObject('MyFood.Page_InformationRequest/Texts/h1_Requisio de Informao'), 'Requisição de Informação')

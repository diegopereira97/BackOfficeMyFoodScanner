...
WebUI.click(findTestObject('MyFood.Page_Home/Links/a_Nutrientes'))

WebUI.verifyElementText(findTestObject('MyFood.Page.Nutrients/Texts/h1_Nutrientes'), 'Nutrientes')

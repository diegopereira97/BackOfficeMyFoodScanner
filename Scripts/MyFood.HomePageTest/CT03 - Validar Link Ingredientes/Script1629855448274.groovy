...
WebUI.click(findTestObject('MyFood.Page_Home/Links/a_Ingredientes'))

WebUI.verifyElementText(findTestObject('MyFood.Page.Ingredients/Texts/h1_Ingredientes'), 'Ingredientes')

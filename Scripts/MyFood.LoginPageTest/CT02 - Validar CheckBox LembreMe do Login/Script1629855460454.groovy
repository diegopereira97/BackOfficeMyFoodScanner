...
WebUI.check(findTestObject('MyFood.Page.Login/CheckBox/input_Login_RememberMe'))
...
WebUI.verifyElementText(findTestObject('MyFood.Page.Login/Fields/input_Email_Login'), 'root')
